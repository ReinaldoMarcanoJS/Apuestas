-- =====================================================
-- ESQUEMA DE BASE DE DATOS PARA RED SOCIAL DE APOSTADORES
-- =====================================================
...
INSERT INTO public.matches (home_team, away_team, league, match_date, status) VALUES
('Real Madrid', 'Barcelona', 'La Liga', NOW() + INTERVAL '2 days', 'upcoming'),
('Manchester United', 'Liverpool', 'Premier League', NOW() + INTERVAL '3 days', 'upcoming'),
('Bayern Munich', 'Borussia Dortmund', 'Bundesliga', NOW() + INTERVAL '1 day', 'upcoming'),
('PSG', 'Marseille', 'Ligue 1', NOW() + INTERVAL '4 days', 'upcoming'),
('Juventus', 'AC Milan', 'Serie A', NOW() + INTERVAL '5 days', 'upcoming');
...
2. Crear las funciones de TypeScript para interactuar con la base de datos
3. Implementar los componentes de React para la UI
*/ 